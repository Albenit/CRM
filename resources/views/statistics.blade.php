...
.gm-style-iw a {
            ...
            <div class="sideBarStyle col-1 col-md-1 col-lg-2 px-1 px-lg-0">
                <div class="mx-4 mx-md-0">
                    <div class="text-center mx-auto py-4 d-flex justify-content-center">
                        <svg style="min-width: 40px; max-width: 80px" class="img-fluid" viewBox="0 0 82 67"
                ...
                <div>
                    <div class="row g-0">
                        <div class="col-auto pe-0 pe-lg-3">
                            <span
                                class="bluePageIndicator {{ request()->is('/') ? 'activePage' : 'passivePageIndicator' }}">
                                ...
                                @if (request()->is('/'))
                                    <svg style="min-width: 20px; max-width: 25px" viewBox="0 0 25 21" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="#2F60DC" stroke="#2F60DC" stroke-width="1.8" />
                                    </svg>
                                @else
                                    <a href="{{ route('dashboard') }}"
                                        class="{{ request()->is('/') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">
                                        <svg style="min-width: 20px; max-width: 25px;" class="img-fluid"
                        ...
                        <div class="col my-auto removeTextOnMobile">
                            <div>
                                <a href="{{ route('dashboard') }}"
                                    class="{{ request()->is('/') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">Startseite</a>
                            </div>
                        </div>
                    </div>
                </div>
                @if (Auth::user()->hasRole('backoffice') || Auth::user()->hasRole('fs') || Auth::user()->hasRole('admin'))
                    <div class="pt-3">
                        <div class="row g-0">
                            <div class="col-auto pe-0 pe-lg-3">
                            ...
                            <div class="col col-lg-2 me-0 me-lg-2 my-auto" style="margin-left: -8px;">
                                <div class="mx-auto text-center ">
                                    @if (request()->is('tasks'))
                                        <svg style="min-width: 15px; max-width: 25px;" viewBox="0 0 25 21"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_197_3288)">
                                                <rect x="4" y="2" width="17" height="18"
                                                    fill="#2F60DC" />
                                                <path
                                                    d="M19.2756 0.953899H15.3806L15.2222 0.356418C15.1679 0.148233 14.9476 0 14.6937 0H10.3063C10.0523 0 9.83295 0.148233 9.77772 0.356418L9.62016 0.953899H5.72439C4.29932 0.953899 3.14062 1.92756 3.14062 3.12462V18.8293C3.14062 20.0264 4.29932 21 5.72439 21H19.2756C20.7007 21 21.8602 20.0264 21.8602 18.8293V3.12462C21.8602 1.92756 20.7006 0.953899 19.2756 0.953899ZM20.1712 18.8293C20.1712 19.2439 19.7696 19.5813 19.2756 19.5813H5.72433C5.23115 19.5813 4.82952 19.2439 4.82952 18.8293V3.12462C4.82952 2.70998 5.23115 2.37266 5.72433 2.37266H9.24487L9.15501 2.71208C9.11869 2.8468 9.15831 2.98812 9.26059 3.09553C9.36361 3.20326 9.51952 3.26593 9.68357 3.26593H15.317C15.4812 3.26593 15.637 3.20326 15.7393 3.09553C15.8424 2.9878 15.882 2.84684 15.8457 2.71208L15.7558 2.37266H19.2756C19.7696 2.37266 20.1712 2.71003 20.1712 3.12462V18.8293Z"
                                                    fill="#2F60DC" />
                                                <path
                                    ...
                                    @else
                                        <a href="{{ route('tasks') }}"
                                            class="text-decoration-none {{ request()->is('tasks') ? 'activePageIndicator' : 'passivePageIndicator' }}">
                                            <svg style="min-width: 20px; max-width: 25px;" viewBox="0 0 25 21"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="col my-auto removeTextOnMobile">
                                <div>
                                    <a href="{{ route('tasks') }}"
                                        class="text-decoration-none {{ request()->is('tasks') ? 'activePageIndicator' : 'passivePageIndicator' }}">Pendenzen</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col col-lg-2 me-0 me-lg-2 my-auto" style="margin-left: -8px;">
                                <div class="mx-auto text-center ">
                                    @if (request()->is('leads'))
                                        <a href="{{ route('leads') }}"
                                            class="{{ request()->is('leads') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">

                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                style="min-width: 15px; max-width: 22px;" fill="currentColor"
                            ...
                            <div class="col my-auto removeTextOnMobile">
                                <div>
                                    <a href="{{ route('leads') }}"
                                        class="{{ request()->is('leads') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">Leads</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    @if (!auth()->user()->hasRole('callagent'))
                        <div class="pt-3">
                            <div class="row g-0">
                                <div class="col-auto pe-0 pe-lg-3">
                                    <span
                                        class="bluePageIndicator {{ request()->is('costumers') ? 'activePage' : '' }}">
                                        <svg style="min-width: 8px;" viewBox="0 0 10 49" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0 0L10 24L0 49V0Z" fill="#2F60DC" />
                                        </svg>
                                ...
                                <div class="col col-lg-2 me-0 me-lg-2 my-auto" style="margin-left: -8px;">
                                    <div class="mx-auto text-center ">
                                        @if (request()->is('costumers'))
                                            <svg style="min-width: 15px; max-width: 25px;" viewBox="0 0 30 30"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <div class="col my-auto removeTextOnMobile">
                                    <div>
                                        <a href="{{ route('costumers') }}"
                                            class="text-decoration-none {{ request()->is('costumers') ? 'activePageIndicator' : 'passivePageIndicator' }}">Kunden</a>
                                    </div>
                                </div>
                ...
                @if (Auth::user()->hasRole('fs') ||
                    ...
                    <div class="pt-3">
                        <div class="row g-0">
                            <div class="col-auto pe-0 pe-lg-3">
                                <span
                                    class="bluePageIndicator {{ request()->is('Appointments') ? 'activePage' : '' }}">
                                    <svg style="min-width: 8px;" viewBox="0 0 10 49" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 0L10 24L0 49V0Z" fill="#2F60DC" />
                                    </svg>
                            ...
                            <div class="col col-lg-2 me-0 me-lg-2 my-auto" style="margin-left: -8px;">
                                <div class="mx-auto text-center ">
                                    @if (request()->is('Appointments'))
                                        <svg width="21" viewBox="0 0 18 19" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <rect x="1.33594" y="5.63005" width="14.5325" height="12.3154"
                                                fill="#2F60DC" />
                                            <path
                                                d="M15.4942 6.33333V17.4167H1.54942V6.33333H15.4942ZM15.4942 4.75H1.54942C0.694141 4.75 0 5.45775 0 6.33333V17.4167C0 18.2923 0.694141 19 1.54942 19H15.4942C16.351 19 17.0436 18.2923 17.0436 17.4167V6.33333C17.0436 5.45775 16.351 4.75 15.4942 4.75ZM16.2689 1.58333H13.9448V0.791667C13.9448 0.354667 13.5977 0 13.1701 0C12.7424 0 12.3954 0.354667 12.3954 0.791667V1.58333H4.64827V0.791667C4.64827 0.354667 4.3012 0 3.87355 0C3.44591 0 3.09884 0.354667 3.09884 0.791667V1.58333H0.774711C0.347071 1.58333 0 1.938 0 2.375C0 2.812 0.347071 3.16667 0.774711 3.16667H16.2689C16.6966 3.16667 17.0436 2.812 17.0436 2.375C17.0436 1.938 16.6966 1.58333 16.2689 1.58333ZM4.64827 7.91667H3.09884V9.5H4.64827V7.91667ZM7.74711 7.91667H6.19769V9.5H7.74711V7.91667ZM10.846 7.91667H9.29653V9.5H10.846V7.91667ZM13.9448 7.91667H12.3954V9.5H13.9448V7.91667ZM4.64827 11.0833H3.09884V12.6667H4.64827V11.0833ZM7.74711 11.0833H6.19769V12.6667H7.74711V11.0833ZM10.846 11.0833H9.29653V12.6667H10.846V11.0833ZM13.9448 11.0833H12.3954V12.6667H13.9448V11.0833ZM4.64827 14.25H3.09884V15.8333H4.64827V14.25ZM7.74711 14.25H6.19769V15.8333H7.74711V14.25ZM10.846 14.25H9.29653V15.8333H10.846V14.25ZM13.9448 14.25H12.3954V15.8333H13.9448V14.25Z"
                                                fill="#2F60DC" />
                                            <rect x="2.63867" y="8.26906" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="2.63867" y="10.9081" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="2.63867" y="13.5471" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="6.1582" y="8.26906" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="6.1582" y="10.9081" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="6.1582" y="13.5471" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="9.67773" y="8.26906" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="9.67773" y="10.9081" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="9.67773" y="13.5471" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="13.1953" y="8.26906" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="13.1953" y="10.9081" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                            <rect x="13.1953" y="13.5471" width="1.75934" height="1.75934"
                                                fill="#F7F7F7" />
                                        </svg>
                                    @else
                                        <a href="{{ route('Appointments') }}"
                                            class="{{ request()->is('Appointments') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">
                                            <svg width="21" viewBox="0 0 18 19" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M15.4942 6.33333V17.4167H1.54942V6.33333H15.4942ZM15.4942 4.75H1.54942C0.694141 4.75 0 5.45775 0 6.33333V17.4167C0 18.2923 0.694141 19 1.54942 19H15.4942C16.351 19 17.0436 18.2923 17.0436 17.4167V6.33333C17.0436 5.45775 16.351 4.75 15.4942 4.75ZM16.2689 1.58333H13.9448V0.791667C13.9448 0.354667 13.5977 0 13.1701 0C12.7424 0 12.3954 0.354667 12.3954 0.791667V1.58333H4.64827V0.791667C4.64827 0.354667 4.3012 0 3.87355 0C3.44591 0 3.09884 0.354667 3.09884 0.791667V1.58333H0.774711C0.347071 1.58333 0 1.938 0 2.375C0 2.812 0.347071 3.16667 0.774711 3.16667H16.2689C16.6966 3.16667 17.0436 2.812 17.0436 2.375C17.0436 1.938 16.6966 1.58333 16.2689 1.58333ZM4.64827 7.91667H3.09884V9.5H4.64827V7.91667ZM7.74711 7.91667H6.19769V9.5H7.74711V7.91667ZM10.846 7.91667H9.29653V9.5H10.846V7.91667ZM13.9448 7.91667H12.3954V9.5H13.9448V7.91667ZM4.64827 11.0833H3.09884V12.6667H4.64827V11.0833ZM7.74711 11.0833H6.19769V12.6667H7.74711V11.0833ZM10.846 11.0833H9.29653V12.6667H10.846V11.0833ZM13.9448 11.0833H12.3954V12.6667H13.9448V11.0833ZM4.64827 14.25H3.09884V15.8333H4.64827V14.25ZM7.74711 14.25H6.19769V15.8333H7.74711V14.25ZM10.846 14.25H9.29653V15.8333H10.846V14.25ZM13.9448 14.25H12.3954V15.8333H13.9448V14.25Z"
                            ...
                            <div class="col my-auto removeTextOnMobile">
                                <div>
                                    <a href="{{ route('Appointments') }}"
                                        class="{{ request()->is('Appointments') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">Kalender</a>
                                </div>
                            </div>
                        </div>
                    </div>
                @endif
                @if (Auth::check() &&
                    !auth()->user()->hasRole('callagent'))
                    <div class="pt-3">
                        <div class="row g-0">
                            <div class="col-auto pe-0 pe-lg-3">
                                <span
                                    class="bluePageIndicator {{ request()->is('hr_view') ? 'activePage' : 'passivePageIndicator' }}">
                                    <svg style="min-width: 8px;" viewBox="0 0 10 49" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 0L10 24L0 49V0Z" fill="#2F60DC" />
                                    </svg>
                            ...
                            <div class="col my-auto removeTextOnMobile">
                                <div>
                                    <a href="{{ route('hr_view') }}"
                                        class="{{ request()->is('hr_view') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">HR</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @if (!auth()->user()->hasRole('callagent') &&
                    ...
                    <div class="pt-3">
                        <div class="row g-0">
                            <div class="col-auto pe-0 pe-lg-3">
                                <span
                                    class="bluePageIndicator {{ request()->is('finance') ? 'activePage' : 'passivePageIndicator' }}">
                                    <svg style="min-width: 8px;" viewBox="0 0 10 49" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 0L10 24L0 49V0Z" fill="#2F60DC" />
                                    </svg>
                                ...
                                <div class="mx-auto text-center ">
                                    ...
                                    @else
                                        <a href="{{ route('finance') }}"
                                            class="{{ request()->is('finance') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">
                            ...
                            <div class="col my-auto removeTextOnMobile">
                                <div>
                                    <a href="{{ route('finance') }}"
                                        class="{{ request()->is('finance') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">Finanzen</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @if (Auth::check() &&
                    ...
                    <div class="pt-3">
                        <div class="row g-0">
                            <div class="col-auto pe-0 pe-lg-3">
                                <span
                                    class="bluePageIndicator {{ request()->is('statistics') ? 'activePage' : 'passivePageIndicator' }}">
                                    <svg style="min-width: 8px;" viewBox="0 0 10 49" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 0L10 24L0 49V0Z" fill="#2F60DC" />
                                    </svg>
                            ...
                            <div class="col col-lg-2 me-0 me-lg-2 my-auto" style="margin-left: -8px;">
                                <div class="mx-auto text-center ">
                                    @if (request()->is('statistics'))
                                        <svg style="min-width: 8px; max-width: 20px;" viewBox="0 0 20 20"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M19.3571 18.7143H15.8401V11.3353C15.8401 10.9802 15.5524 10.6924 15.1973 10.6924H13.007C12.6519 10.6924 12.3641 10.9802 12.3641 11.3353V18.7143H11.0855V8.23843C11.0855 7.88336 10.7977 7.59557 10.4426 7.59557H8.25236C7.89729 7.59557 7.6095 7.88336 7.6095 8.23843V18.7143H6.33093V5.11093C6.33093 4.75586 6.04314 4.46807 5.68807 4.46807H3.49779C3.14271 4.46807 2.85493 4.75586 2.85493 5.11093V18.7143H1.28571V0.642857C1.28571 0.287786 0.997929 0 0.642857 0C0.287786 0 0 0.287786 0 0.642857V19.3571C0 19.7122 0.287786 20 0.642857 20H19.3571C19.7122 20 20 19.7122 20 19.3571C20 19.0021 19.7122 18.7143 19.3571 18.7143ZM13.6499 11.9781H14.5544V18.7143H13.6499V11.9781ZM8.89529 8.88129H9.79986V18.7143H8.89529V8.88129ZM4.14064 5.75379H5.04521V18.7143H4.14064V5.75379Z"
                                                fill="#2F60DC" />
                                            <rect x="3.63672" y="5.45453" width="1.81818" height="13.6364"
                                                fill="#2F60DC" />
                                            <rect x="8.18359" y="8.18182" width="1.81818" height="10.9091"
                                                fill="#2F60DC" />
                                            <rect x="13.6367" y="11.8182" width="1.81818" height="7.27273"
                                                fill="#2F60DC" />
                                        </svg>
                                    @else
                                        <a href="{{ route('statistics') }}"
                                            class="{{ request()->is('statistics') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">
                                            <svg style="min-width: 8px; max-width: 20px;" viewBox="0 0 20 20"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M19.3571 18.7143H15.8401V11.3353C15.8401 10.9802 15.5524 10.6924 15.1973 10.6924H13.007C12.6519 10.6924 12.3641 10.9802 12.3641 11.3353V18.7143H11.0855V8.23843C11.0855 7.88336 10.7977 7.59557 10.4426 7.59557H8.25236C7.89729 7.59557 7.6095 7.88336 7.6095 8.23843V18.7143H6.33093V5.11093C6.33093 4.75586 6.04314 4.46807 5.68807 4.46807H3.49779C3.14271 4.46807 2.85493 4.75586 2.85493 5.11093V18.7143H1.28571V0.642857C1.28571 0.287786 0.997929 0 0.642857 0C0.287786 0 0 0.287786 0 0.642857V19.3571C0 19.7122 0.287786 20 0.642857 20H19.3571C19.7122 20 20 19.7122 20 19.3571C20 19.0021 19.7122 18.7143 19.3571 18.7143ZM13.6499 11.9781H14.5544V18.7143H13.6499V11.9781ZM8.89529 8.88129H9.79986V18.7143H8.89529V8.88129ZM4.14064 5.75379H5.04521V18.7143H4.14064V5.75379Z"
                            ...
                            <div class="col my-auto removeTextOnMobile">
                                <div>
                                    <a href="{{ route('statistics') }}"
                                        class="{{ request()->is('statistics') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">Statistik</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    @if (Auth::check())
                        <div class="">
                            <div class="row g-0">
                                <div class="col-auto pe-0 pe-lg-3">
                                    <span
                                        class="bluePageIndicator {{ request()->is('addnewuser') ? 'activePage' : '' }}">
                                        <svg style="min-width: 8px;" viewBox="0 0 10 49" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0 0L10 24L0 49V0Z" fill="#2F60DC" />
                                        </svg>
                                ...
                                <div class="col my-auto removeTextOnMobile">
                                    <div>
                                        <a href="{{ route('addnewuser') }}"
                                            class="{{ request()->is('addnewuser') ? 'activePageIndicator' : 'passivePageIndicator' }} text-decoration-none">Einstellungen</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col col-lg-2 me-0 me-lg-2 my-auto" style="margin-left: -8px;">
                                    <div class="mx-auto text-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="21" viewBox="0 0 24 24"
                                            fill="none" stroke="#A7A4A4" stroke-width="2" stroke-linecap="round"
                                ...
                                <div class="col my-auto removeTextOnMobile">
                                    <div>
                                        <a href="{{ action('App\Http\Controllers\UserController@changerole') }}"
                                            class="passivePageIndicator text-decoration-none">Rolle wechseln</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pt-3">
                        <div class="row g-0">
                            ...
                            <div class="col my-auto removeTextOnMobile">
                                <div>
                                    <a href="{{ route('logout') }}"
                                        class=" passivePageIndicator text-decoration-none">Abmelden</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row g-0 justify-content-between" style="position: relative;">
                                            ...
                                            <div class="col-auto my-auto">
                                                ...
                                                <div class="statsSelectStyleDropdown" id="dropdownSelectId1"
                                                    style="display: none;">
                                                    <div class="py-2">
                                                        <div class="row g-0" onclick="makeSelectActive1(this,1)">
                                                            <div class="col-auto my-auto ps-3">
                                                                <div>
                                                                    <svg width="19" height="19"
                                                                        viewBox="0 0 19 19" fill="none"
                                                    ...
                                                    <div class="py-2">
                                                        <div class="row g-0" onclick="makeSelectActive1(this,7)">
                                                            <div class="col-auto my-auto ps-3">
                                                                <div>
                                                                    <svg class="activeSvg1" width="19"
                                                                        height="19" viewBox="0 0 19 19"
                                                                        fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <circle cx="9.5" cy="9.5"
                                                    ...
                                                    <div class="py-2">
                                                        <div class="row g-0" onclick="makeSelectActive1(this,30)">
                                                            <div class="col-auto my-auto ps-3">
                                                                <div>
                                                                    <svg width="19" height="19"
                                                                        viewBox="0 0 19 19" fill="none"
                                                    ...
                                                    <div class="py-2">
                                                        <div class="row g-0" onclick="makeSelectActive1(this,120)">
                                                            <div class="col-auto my-auto ps-3">
                                                                <div>
                                                                    <svg width="19" height="19"
                                                                        viewBox="0 0 19 19" fill="none"
                                                    ...
                                                    <div class="py-2">
                                                        <div class="row g-0" onclick="makeSelectActive1(this,365)">
                                                            <div class="col-auto my-auto ps-3">
                                                                <div>
                                                                    <svg width="19" height="19"
                                                                        viewBox="0 0 19 19" fill="none"
                                                    ...
                                                    <div class="py-2">
                                                        <div class="row g-0" onclick="makeSelectActive1(this,0)">
                                                            <div class="col-auto my-auto ps-3">
                                                                <div>
                                                                    <svg width="19" height="19"
                                                                        viewBox="0 0 19 19" fill="none"
                                                    ...
                                                    <div class="py-2" style="border-top: 1px solid #E8E8E8;">
                                                        <div class="row g-0" onclick="vertrageCostum()"
                                                            style="cursor: pointer">
                                                            <div class="col-auto my-auto ps-3">
                                                                <div>
                                                                    <svg width="18" height="12"
                                                    ...
                                                    <div id="vertrageCostum" style="display: none">
                                                        ...
                                                        <div class="pb-2 pt-2">
                                                            <div class="row g-0">
                                                                <div class="col my-auto ps-2 pe-2">
                                                                    <div>
                                                                        <input onclick="makeSelectActive1(this,100)"
                                                                            class="col-12 py-1" type="button"
                                                                            value="Suche"
                                                                            style="background-color:#2F60DC; color:#fff;border:#2F60DC; border-radius:8px;font-weight:700">
                                                                    </div>
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-end">
                                                                <div>
                                                                    <span
                                                                        class="contractsFirstSpan">Rechtschutz</span>
                                                                </div>
                                                                <div>
                                                                    <span class="contractsSecondSpan fs-4"
                                                                        id="rechts"></span>
                                                        ...
                                                        <div class="col-auto">
                                                            <svg width="66" height="56" viewBox="0 0 66 56"
                                                                ...
                                                                <path d="M47.5703 41.238L18.0503 41.238"
                                                                    stroke="#3670BD" stroke-width="3"
                                                                    stroke-linecap="round" />
                                                                <line x1="26.9557" y1="35.4737" x2="37.8374"
                                                                    y2="24.816" stroke="#3670BD"
                                                                    stroke-width="3" stroke-linecap="round" />
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="">
                                                                            <div class="row g-0 pb-3">
                                                                                ...
                                                                                <div class="col">
                                                                                    <span
                                                                                        style="font-weight: 500;">Abgeschlossen</span>
                                                                                </div>
                                                                                <div class="col-2 text-end">
                                                                                    <span style="font-weight: 700;"
                                                                                        id="abgeschlossen"></span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row g-0 pb-3">
                                                                                <div class="col-auto my-auto me-2">
                                                                                ...
                                                                                <div class="col">
                                                                                    <span
                                                                                        style="font-weight: 500;">Nicht
                                                                                        abgeschlossen</span>
                                                                                </div>
                                                                                <div class="col-2 text-end">
                                                                                    <span style="font-weight: 700;"
                                                                                        id="nichtabgeschlossen"></span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row g-0 pb-3">
                                                                                <div class="col-auto my-auto me-2">
                                                                ...
                                                                <div class="whiteBgGraph h-100 p-3">
                                                                    ...
                                                                    <div class="ps-2 ps-lg-3 pt-1">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-auto ps-0">
                                                                                <div
                                                                                    class="BlueSmallDiv text-center px-2">
                                                                                    <span>--</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                    ...
                                                                                    <div class="pb-2 pt-2">
                                                                                        <div class="row g-0">
                                                                                            <div
                                                                                                ...
                                                                                                <div>
                                                                                                    <input
                                                                                                        onclick="makeSelectActive6(this,100)"
                                                                                                        class="col-12 py-1"
                                                                                                        type="button"
                                                                                                        value="Suche"
                                                                                                        style="background-color:#2F60DC; color:#fff;border:#2F60DC; border-radius:8px;font-weight:700">
                                                                                        ...
                                                                                        <div class="pb-2 pt-2">
                                                                                            <div class="row g-0">
                                                                                                <div
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <input
                                                                                                            onclick="makeSelectActive7(this,100)"
                                                                                                            class="col-12 py-1"
                                                                                                            type="button"
                                                                                                            value="Suche"
                                                                                                            style="background-color:#2F60DC; color:#fff;border:#2F60DC; border-radius:8px;font-weight:700">
                                                                                        ...
                                                                                        <div class="pb-2 pt-2">
                                                                                            <div class="row g-0">
                                                                                                <div
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <input
                                                                                                            onclick="makeSelectActive8(this,100)"
                                                                                                            class="col-12 py-1"
                                                                                                            type="button"
                                                                                                            value="Suche"
                                                                                                            style="background-color:#2F60DC; color:#fff;border:#2F60DC; border-radius:8px;font-weight:700">
                                                                        ...
                                                                        <div class="pt-3">
                                                                            <div class="row g-0">
                                                                                <div class="col-12 col-sm mx-auto"
                                                                                    style="max-width: 300px;min-width: 270px;">
                                                                                    <div id="chart7"></div>
                                                                                </div>
                                                                                <div
                                                                                    class="col-12 col-sm my-auto ps-0 ps-sm-5 pt-4 pt-sm-0">
                                                                                    <div>
                                                                                        <div class="row g-0 pb-2">
                                                                                            <div
                                                                                                class="col-auto my-auto me-2">
                                                                                                <svg width="26"
                                                                                                    height="9"
                                                                                                    viewBox="0 0 26 9"
                                                                                                    fill="none"
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <span
                                                                                                    style="font-weight: 500;">Abschluss</span>
                                                                                            </div>
                                                                                            <div
                                                                                    ...
                                                                                    <div class="pb-3">
                                                                                        <div class="row g-0 pb-2">
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <span
                                                                                                    style="font-weight: 500;">Folget</span>
                                                                                            </div>
                                                                                            <div
                                                                                                class="col-2 text-end">
                                                                                                <span
                                                                                    ...
                                                                                    <div>
                                                                                        <div class="row g-0 ">
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <span
                                                                                                    style="font-weight: 500;">Total</span>
                                                                                            </div>
                                                                                            <div
                                                                                                class="col-2 text-end">
                                                                                                <span
    ...
    <div class="mobile-nav" id="mobile-nav">
        <a href="{{ route('dashboard') }}"
            class="m-nav {{ request()->is('/') ? 'activeClassNavMob__' : '' }}">
            <span>
                <svg class="img-fluid " width="26" viewBox="0 0 25 21" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M9.91637 12.6H9.01637V13.5V19.75C9.01637 19.9128 8.8661 20.1 8.6247 20.1H4.7497C4.50829 20.1 4.35803 19.9128 4.35803 19.75V11V10.1H3.45803H1.99054L12.2234 1.18035C12.2237 1.18012 12.2239 1.17989 12.2242 1.17966C12.3767 1.0484 12.6227 1.0484 12.7752 1.17966C12.7755 1.17989 12.7757 1.18012 12.776 1.18035L23.0089 10.1H21.5414H20.6414V11V19.75C20.6414 19.9128 20.4911 20.1 20.2497 20.1H16.3747C16.1333 20.1 15.983 19.9128 15.983 19.75V13.5V12.6H15.083H9.91637Z"
                        stroke="#A7A4A4" stroke-width="1.8" />
        ...
        @if (in_array('backoffice', $urole) || in_array('fs', $urole) || in_array('admin', $urole))
            <a href="{{ route('tasks') }}"
                class="m-nav {{ request()->is('tasks') ? 'activeClassNavMob__' : '' }}">
                <span>
                    <svg width="26" viewBox="0 0 25 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_171_588)">
                            <path
                                d="M19.2756 0.953899H15.3806L15.2222 0.356418C15.1679 0.148233 14.9476 0 14.6937 0H10.3063C10.0523 0 9.83295 0.148233 9.77772 0.356418L9.62016 0.953899H5.72439C4.29932 0.953899 3.14062 1.92756 3.14062 3.12462V18.8293C3.14062 20.0264 4.29932 21 5.72439 21H19.2756C20.7007 21 21.8602 20.0264 21.8602 18.8293V3.12462C21.8602 1.92756 20.7006 0.953899 19.2756 0.953899ZM20.1712 18.8293C20.1712 19.2439 19.7696 19.5813 19.2756 19.5813H5.72433C5.23115 19.5813 4.82952 19.2439 4.82952 18.8293V3.12462C4.82952 2.70998 5.23115 2.37266 5.72433 2.37266H9.24487L9.15501 2.71208C9.11869 2.8468 9.15831 2.98812 9.26059 3.09553C9.36361 3.20326 9.51953 3.26593 9.68357 3.26593H15.317C15.4812 3.26593 15.637 3.20326 15.7393 3.09553C15.8424 2.9878 15.882 2.84684 15.8457 2.71208L15.7558 2.37266H19.2756C19.7696 2.37266 20.1712 2.71003 20.1712 3.12462V18.8293Z"
                                fill="#A7A4A4" />
        ...
        @if (Auth::guard('admins')->check())
            <a href="{{ route('costumers') }}"
                ...
                <span>
                    <svg width="26" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M14.6364 16.3418C15.5814 15.3135 16.1605 13.9336 16.1605 12.4189C16.1605 9.24902 13.6252 6.6709 10.5079 6.6709C7.39069 6.6709 4.8554 9.24902 4.8554 12.4189C4.8554 13.9395 5.44025 15.3223 6.39098 16.3535C5.78597 16.7109 5.22417 17.1533 4.71424 17.6689C3.16425 19.2451 2.30859 21.3428 2.30859 23.5752C2.30859 24.9287 2.63703 25.8897 3.3083 26.5078C4.38868 27.501 5.99628 27.3311 7.85453 27.1377C8.70731 27.0498 9.5889 26.9561 10.5195 26.9561C11.45 26.9561 12.3316 27.0469 13.1844 27.1377C13.9104 27.2139 14.599 27.2842 15.2328 27.2842C16.221 27.2842 17.0738 27.1113 17.7306 26.5049C18.4048 25.8867 18.7303 24.9287 18.7303 23.5723C18.7303 21.3428 17.8747 19.2451 16.3247 17.666C15.8176 17.1445 15.2472 16.7021 14.6364 16.3418ZM10.5079 8.5459C12.6082 8.5459 14.3166 10.2832 14.3166 12.4189C14.3166 14.5547 12.6082 16.292 10.5079 16.292C8.40769 16.292 6.69925 14.5547 6.69925 12.4189C6.70213 10.2832 8.41057 8.5459 10.5079 8.5459ZM16.5004 25.1133C16.028 25.5469 14.7401 25.4121 13.3774 25.2715C12.5189 25.1836 11.548 25.0811 10.5252 25.0811C9.50247 25.0811 8.53157 25.1836 7.67303 25.2715C6.31031 25.4121 5.0225 25.5469 4.55002 25.1133C4.29073 24.8731 4.1582 24.3574 4.1582 23.5723C4.1582 20.8887 5.77445 18.5801 8.06773 17.5986C8.80815 17.9619 9.63788 18.1641 10.5137 18.1641C11.4673 18.1641 12.3662 17.9209 13.1556 17.4961C13.1239 17.54 13.0893 17.584 13.0519 17.625C15.3106 18.6211 16.8951 20.9121 16.8951 23.5693C16.8923 24.3545 16.7597 24.8731 16.5004 25.1133Z"
                            fill="#A7A4A4" />
                        <path
        ...
        @if (in_array('admin', $urole) ||
            ...
            <a href="{{ route('leads') }}"
                class="m-nav {{ request()->is('leads') ? 'activeClassNavMob__' : '' }}">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" fill="none"
                        class="bi bi-hdd-stack" viewBox="0 0 16 16">
                        <path fill="#A7A4A4"
                            d="M14 10a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1h12zM2 9a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2H2z" />
                        <path fill="#A7A4A4"
        ...
        <div class="m-nav" onclick="openBurgerFunct()">
            <span>
                <svg width="26" height="26" viewBox="0 0 20 14" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 7H19" stroke="#A7A4A4" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M1 1H19" stroke="#A7A4A4" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M1 13H19" stroke="#A7A4A4" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            </span>
        </div>
            ...
            <div class="row">
                ...
                <div class="col me-2 mt-2">
                    <div class="my-auto text-end pe-2">
                        <svg onclick="openBurgerFunct()" width="18" height="18" viewBox="0 0 20 20"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M18 2L2 18" stroke="#434343" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M2 2L18 18" stroke="#434343" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </div>
                </div>
        ...
        <div class="content-of-burger col-9 mx-auto">
            <div class="my-3 m-burger">
                @if (in_array('fs', $urole) ||
                    ...
                    <a href="{{ route('Appointments') }}"
                        ...
                        <div class="row g-0">
                            <div class="col-auto my-auto me-3">
                                <svg width="22" viewBox="0 0 21 23" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div class="col my-auto">
                                <div>
                                    <span
                                        class="fs-6 {{ request()->is('Appointments') ? 'activeClassNavMob__' : '' }}"
                                        style="color: #A7A4A4;font-weight: 500">
                                        Kalender
                                    </span>
                                </div>
                            </div>
            ...
            <div class="my-3 m-burger">
                <a href="{{ route('hr_view') }}"
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col my-auto">
                            <div>
                                <span class="fs-6 {{ request()->is('hr_view') ? 'activeClassNavMob__' : '' }}"
                                    style="color: #A7A4A4;font-weight: 500">
                                    HR
                                </span>
                            </div>
            ...
            <div class="my-3 m-burger">
                @if (Auth::check() &&
                    ...
                    !auth()->user()->hasRole('backoffice'))
                    <a href="{{ route('finance') }}"
                        class="m-nav text-decoration-none {{ request()->is('finance') ? 'activeClassNavMob__' : '' }}">
                        <div class="row g-0">
                            <div class="col-auto pe-3">
                                <svg width="22" height="24" viewBox="0 0 23 15" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M20.2927 0H5.14407C3.71769 0 2.55754 1.06117 2.55754 2.36567V2.57302C1.14468 2.58773 0 3.64193 0 4.93727V12.2971C0 13.6016 1.16038 14.6628 2.58654 14.6628H17.7352C19.1614 14.6628 20.3217 13.6016 20.3217 12.2971V12.0898C21.7343 12.0754 22.8793 11.0212 22.8793 9.72551V2.36578C22.8796 1.06128 21.7189 0 20.2927 0ZM18.6632 12.2971C18.6632 12.6803 18.2384 13.0038 17.7355 13.0038H2.58686C2.08397 13.0038 1.65924 12.6803 1.65924 12.2971V4.93738C1.65924 4.5544 2.08419 4.23073 2.58686 4.23073H17.7355C18.2384 4.23073 18.6632 4.55451 18.6632 4.93738V12.2971ZM20.3221 10.4299V4.93727C20.3221 3.63277 19.1617 2.5716 17.7355 2.5716H4.21645V2.36567C4.21645 1.98269 4.6414 1.65902 5.14407 1.65902H20.2927C20.7956 1.65902 21.2204 1.9828 21.2204 2.36567V9.72551H21.2207C21.2206 10.101 20.8118 10.4174 20.3221 10.4299Z"
                                        fill="#A7A4A4" />
                            ...
                            <div class="col">
                                <div>
                                    <span
                                        class="fs-6 {{ request()->is('finance') ? 'activeClassNavMob__' : '' }} "
                                        style="color: #A7A4A4;font-weight: 500">
                                        Finanzen
                                    </span>
                                </div>
            ...
            <div class="my-3 m-burger">
                @if (Auth::check() &&
                    !auth()->user()->hasRole('callagent'))
                    <a href="{{ route('statistics') }}"
                        class="m-nav text-decoration-none {{ request()->is('statistics') ? 'activeClassNavMob__' : '' }}">
                        <div class="row g-0">
                            <div class="col-auto pe-3">
                            ...
                            <div class="col">
                                <div>
                                    <span
                                        class="fs-6 {{ request()->is('statistics') ? 'activeClassNavMob__' : '' }}"
                                        style="color: #A7A4A4;font-weight: 500">
                                        Statistik
                                    </span>
                                </div>
                    ...
                    <a href="{{ route('addnewuser') }}"
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col ">
                                <div>
                                    <span
                                        class="fs-6 {{ request()->is('addnewuser') ? 'activeClassNavMob__' : '' }}"
                                        style="color: #A7A4A4;font-weight: 500">
                                        Einstellungen
                                    </span>
                                </div>
            ...
            <div class="my-3 m-burger">
                @if (auth()->user()->admin_id != null)
                    <a href="{{ action('App\Http\Controllers\UserController@changerole') }}"
                        class="m-nav text-decoration-none">
                        <div class="row g-0">
                            <div class="col-auto pe-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24"
                                    fill="#a7a4a4" class="bi bi-person-check" viewBox="0 0 16 16">
                                    <path
    ...
    <script>
            ...
            axios.get('filterLead?number=' + number + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo).then(response => {
                ...
                if (response.data[0] + response.data[1] + response.data[2] == 0) {
                    document.querySelector("#chart3").innerHTML =
                        '<div class="text-center fs-6 fw-400 d-flex h-100 justify-content-center align-items-center py-5" style="color: #d1d1d1">' +
        ...
        function makeSelectActive6(x, number) {
            ...
            axios.get('durationOfLead?number=' + number + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo).then(response => {
                if (response.data[0] + response.data[1] + response.data[2] + response.data[3] + response.data[4] +
                    response.data[5] + response.data[6] + response.data[7] + response.data[8] + response.data[9] +
                    response.data[10] + response.data[11] == 0) {
                    ...
                    var options = {
                        ...
                        series: [{
                            name: "Days",
                            data: [response.data[0], response.data[1], response.data[2], response.data[
                                    3],
                                response.data[4], response.data[5], response.data[6], response.data[
                                    7],
                                response.data[8], response.data[9], response.data[10], response
                                .data[11]
                            ],
                            colors: ['#C74E46']
                        }],
        ...
        async function makeSelectActive7(x, number) {
            ...
            await axios.get('holidayReason?number=' + number + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo).then(
                response => {
        ...
        function makeSelectActive8(x, number) {
            ...
            axios.get('appointmentStat?number=' + number + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo).then(response => {
                ...
                document.getElementById('tertotal').innerHTML = response.data[0] + response.data[1] + response.data[
                    2] + response.data[3]
                if (response.data[0] + response.data[1] + response.data[2] + response.data[3] == 0) {
