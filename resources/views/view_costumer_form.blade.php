                        ...
                        <nav class="g-0 nav-form-links">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link col active status-btn" id="nav-home-tab"
                                        ...
                                        aria-controls="nav-home" aria-selected="true" onclick="changecnt(0)"><span
                                        class="desk-t">Status</span><span class="mobile-t">S</span>
                                    <div><span class="mobile-t" style="font-size: 10px;">Status</span></div>
                                </button>
                                <button class="nav-link col auto-btn" id="nav-profile-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-profile" type="button" role="tab"
                                        aria-controls="nav-profile" aria-selected="false"
                                        onclick="changecnt(1)"><span class="desk-t">Personeninformationen </span><span
                                        class="mobile-t">A</span>
                                    <div><span class="mobile-t" style="font-size: 10px;">Personeninformationen </span></div>
                                </button>
                                <button class="nav-link col sachen-btn" id="nav-contact-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-contact" type="button" role="tab"
                                        aria-controls="nav-contact" aria-selected="false"
                                        onclick="changecnt(2)"><span class="desk-t">Produkte</span><span
                                        class="mobile-t">P</span>
                                    <div><span class="mobile-t" style="font-size: 10px;">Produkte</span></div>
                                </button>
                            </div>
                        </nav>
                    </div>
                        ...
                        <div class="tab-pane fade auto-content" id="nav-profile" role="tabpanel"
                            ...
                            <div class="p-4">
                                ...
                                <div class="row g-0 mt-3">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4 mb-4 pe-0 pe-md-0 pe-xl-4 ps-md-4 ps-xl-0 pt-4 pt-md-0">
                                            ...
                                            <div class="documentFormGreyBGDiv h-100">
                                                <div class="p-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">Abschlussdatum</span>
                                                            </div>
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$grundversicherungPP->graduation_date_PG}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">Produkt</span>
                                                            </div>
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$grundversicherungPP->product_PG}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$zusatzversicherungPP->graduation_date_PZ}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$zusatzversicherungPP->produkt_PZ}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">VVG Pramie</span>
                                                            </div>
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$zusatzversicherungPP->vvg_premium_PZ}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-2">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">Laufzeit</span>
                                                            </div>
                                                            <div class="col">
                                                                <div class="col">
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$retchsschutzP->graduation_date_PR}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$retchsschutzP->produkt_PR}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                            ...
                                            <div class="documentFormGreyBGDiv h-100">
                                                <div class="p-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">Beginn Versicherung</span>
                                                            </div>
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$autoversicherungP->beginning_insurance_PA}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">Versicherung</span>
                                                            </div>
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$autoversicherungP->insurance_PA}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$hausratP->beginning_insurance_PH}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$hausratP->insurance_PH}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$vorsorgeP->graduation_date_PV}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">Beginn</span>
                                                            </div>
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$vorsorgeP->begin_PV}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">Pramie</span>
                                                            </div>
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$vorsorgeP->pramie_PV}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">Zahlungsrythmus</span>
                                                            </div>
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$vorsorgeP->payment_rythm_PV}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-2">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">Produktion</span>
                                                            </div>
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$vorsorgeP->production_PV}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
