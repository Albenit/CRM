...
<div class="row g-0 justify-content-center">
    ...
    <div class="my-0 my-sm-4 col-12 col-sm-11 col-md-11 col-lg-10 g-0">
        <div class="col">
            <section>
            ...
            <div class="wrapper-div px-3 px-md-4 py-0 py-sm-4 mx-0 mx-sm-3 pb-4">
                <div class="row g-0">
                    <div class="row g-0 pt-4 pt-md-0">
                        <div class="col-auto pe-0 my-auto pe-5 ps-2">
                            ...
                            <div class="">
                                <span class="fs-6 text-white smallTextMobile">
                                    <span class="">
                                     ...
                                     {{$app->address}} {{$app->nr}} {{$app->city}} {{$app->postal_code}}
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            <div class="info-divv px-2 my-3">
                                <div class="row g-2">
                                    ...
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Vorname </span> <span class="fs-6">{{$app->first_name}} </span>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Nachname </span> <span class="fs-6">{{$app->last_name}}</span>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Strasse </span> <span class="fs-6">{{$app->address}}</span>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Nr </span> <span class="fs-6">{{$app->nr}}</span>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    ...
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Ort</span> <span class="fs-6">{{$app->city}}</span>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    ...
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Sprache </span><span class="fs-6">{{$app->sprache}}</span>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Tel. Privat</span> <span class="fs-6">{{$app->telephone}}</span>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Personen </span> <span class="fs-6">{{$app->number_of_persons}}</span>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Datum </span> <span class="fs-6">{{$app->appointment_date}}</span>                                        </div>
                                            </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Zeit </span> <span class="fs-6">{{$app->time}}</span>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    <div class="white-thingy">
                                                <div class="text-div py-3 ps-4">
                                                    <span class="fw-600 fs-6 pe-1">Zufriedenheit </span> <span class="fs-6">{{$app->zufriedenheit}}</span>
                                                </div>
                                            </div>
                                    </div>
                                </div>
                                <div class="white-thingy mt-2">
                                    <div class="text-div py-3 ps-4">
                                        <span class="fw-600 fs-6 pe-1">Bemerkung </span> <span class="fs-6">{{$app->bemerkung}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="other-people-accordion pb-4 pt-2 mt-1 col-12 col-sm-12 col-md-12 col-lg-4 col-xl-5 g-0">
                        @php
                            $leadss = $app->id * 1244;
                        ...
                        <form action="{{route('completeapp',$appId)}}" method="post">
                                ...
                                <div class="accordion accordion-flush mx-2 " id="accordionFlushExample">
                                    ...
                                    <div class="accordion-item my-1">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body p-0 mx-2 pb-2">
                            ...
                            <div class="my-2 text-center">
                                <a  href="{{route('insertPerson',$app->id)}}" style="cursor: pointer; text-decoration: none">
                                     <svg xmlns="http://www.w3.org/2000/svg" width="28" fill="#fff" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
                                         <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3z"/>
                                     </svg>
                                </a>
                            </div>
                            <div class="mx-3">
                                <button type="submit" class="w-100 py-2 border-0 acceptBtnKunden">
                                    <span class="fw-bold fs-6">Kunden erfassen</span>
                                </button>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    for (i = 2; i <= count; i++) {
        $("#accordionFlushExample").append(' <div class="accordion-item my-1">' +
            ...
            '                                                data-bs-toggle="collapse" id="flushcollapse' + i + '2" data-bs-target="#flush-collapse' + i + '"' +
            ...
            '                                                    </div>' +
            '                                                    <div class="col">' +
            '                                                        <input type="date" value="dd/mm/yyyy" id="inputTxt6" class="form-control" name="birthday' + i + '"' +
            '                                                            aria-describedby="passwordHelpInline">' +
            '                                                    </div>' +
            '                                                </div>' +
            '                                                <div class="text-end">' +
            '                                                    <button class="accept-btn m-2 py-1 px-5 collapsed" type="button"' +
            '                                                        data-bs-toggle="collapse" onclick="collapsee(' + i + ')" data-bs-target="#flush-collapse' + i + '"' +
...
<script>
    ...
    function collapsee(x){
        x = x + 1;

        $('#flushcollapse' + x + '2').addClass('collapsed');
        $('#flush-collapse' + x).addClass('show');
    }
    </script>
</body>
</html>
