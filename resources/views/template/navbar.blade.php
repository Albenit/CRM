        ...
        <div class="col-1 col-md-1 col-lg-2 h-100 hideNavBarMobile" id="navbarId">
            <div class="sideBarStyle col-1 col-md-1 col-lg-2 px-1 px-lg-0" id="underNavbarId">
                ...
                <div class="pt-3">
                    <div class="row g-0">
                        <div class="col-auto pe-0 pe-lg-3">
                            <span class="bluePageIndicator {{request()->is('costumers') || request()->is('search')  ? 'activePage' : '' }}">
                                <svg style="min-width: 8px;" viewBox="0 0 10 49" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 0L10 24L0 49V0Z" fill="#2F60DC" />
                                </svg>
                        ...
                        <div class="col col-lg-2 me-0 me-lg-2 my-auto" style="margin-left: -8px;">
                            <div class="mx-auto text-center ">
                                @if(request()->is('costumers') || request()->is('search'))
                                ...
                                @else
                                    <a href="{{route('costumers')}}" class="text-decoration-none {{request()->is('costumers') || request()->is('search')  ? 'activePageIndicator' : 'passivePageIndicator' }}">
                        ...
                        <div class="col my-auto removeTextOnMobile">
                            <div>
                                <a href="{{route('costumers')}}" class="text-decoration-none {{request()->is('costumers') || request()->is('search')   ? 'activePageIndicator' : 'passivePageIndicator' }}">Kunden</a>
                            </div>
                        </div>
                ...
                @endif
                @if(!auth()->user()->hasRole('callagent') && !auth()->user()->hasRole('backoffice') && !auth()->user()->hasRole('fs') && !auth()->user()->hasRole('salesmanager'))
                    <div class="pt-3">
                        <div class="row g-0">
                            <div class="col-auto pe-0 pe-lg-3">
...
{{--        Mobile--}}
        ...
        <div class="bottom-burger-modal" id="bottom-burger" style="display: none; text-decoration: none !important;">
            ...
            <div class="my-3 m-burger">
                ...
                <div class="my-3 m-burger">
                @if(Auth::check() && !auth()->user()->hasRole('backoffice') && !auth()->user()->hasRole('callagent')  && !auth()->user()->hasRole('fs') && !auth()->user()->hasRole('salesmanager'))
        ...
        <div class="container-fluid col-12 col-sm-11 col-lg-10 g-0 pb-5 pb-md-0" id="app">
            @if(Illuminate\Support\Facades\Session::has('success'))
                <div style="background: #DEF2D5 !important;border-radius: 8px !important;" class="alert alert-success alert-dismissible fade show m-3 px-3" role="alert">
                    <div class="row g-0">
                        <div class="col my-auto">
                        <div style="font-weight: 600;color: #377449;">{!! Illuminate\Support\Facades\Session::get('success') !!}</div>
            ...
            @if(Illuminate\Support\Facades\Session::has('fail'))
                <div style="border-radius: 8px !important;" class="alert alert-danger alert-dismissible fade show m-3" role="alert">
                <div class="row g-0">
                        <div class="col my-auto">
