...
@section('content')
    ...
    <div class="px-4 px-lg-5 pt-4 pt-lg-5 ">
        <div class="mb-5">
                <div class="row gy-4 gx-2 gx-sm-3">
                    ...
                    <div class="col-6 col-sm-6 col-lg-4 col-xxl ">
                        <div class="adminBorderDiv p-4"
                            style="cursor:pointer;">
                            <div class="cornerSvgDash justfiy-content-center">
                            ...
                            <div class="text-end textDivDash">
                                <div>
                                    <span class="bigTitleDashAdmin">{{$totalTermins}}</span>
                                </div>
                                <div>
                                    <span class="smallTitleDash">Total Termine</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 col-lg-4 col-xxl">
                        <div class="adminBorderDiv p-4"
                            ...
                            <div class="text-end textDivDash">
                                <div>
                                    <span class="bigTitleDashAdmin">{{$allContracts}}</span>
                                </div>
                                <div>
                                    <span class="smallTitleDash">Total Contract</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 col-lg-4 col-xxl">
                        <div class="adminBorderDiv p-4"
                            ...
                            <div class="text-end textDivDash">
                                <div>
                                    <span class="bigTitleDashAdmin">{{$totalkunden}}</span>
                                </div>
                                <div>
                                    <span class="smallTitleDash">Total Kunden</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 col-lg-4 col-xxl ">
                        <div class="adminBorderDiv p-4"
                            ...
                            <div class="text-end textDivDash">
                                <div>
                                    <span class="bigTitleDashADmin">{{$allProvisnojns}} CHF</span>
                                </div>
                                <div>
                                    <span class="smallTitleDash">Total Income Provisionert</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
                <div class="col-12 col-lg-12 col-xl-12 col-xxl-5 mb-5">
                    <div class="greyBgStats p-3 p-sm-4">
                        <div>
                            <div style="position: relative;">
                                <div class="col my-auto">
                                    <div>
                                        <span class="statsTitleSpanAdmin">Sales chart</span>
                                    </div>
                                    <div>
                                        <div class="row g-0">
                ...
                <div class="col-12 col-lg-12 col-xl-12 col-xxl-4 mb-5">
                    <div class="greyBgStats p-3 p-sm-4 h-100">
                        <div>
                            <div style="position: relative;">
                                <div class="col my-auto">
                                    <div>
                                        <span class="statsTitleSpanAdmin">Team performance</span>
                                    </div>
                                    <div>
                                        <div class="row g-0">
                                            <div class="col-12" style="position: relative;">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="row g-0">
                                                                    ...
                                                                    <div class="col-auto my-auto">
                                                                        <div class="statsSelectStyle py-1" onclick="openDropDownSelect2()" style="cursor: pointer;">
                                                                            <div class="row g-0">
                                                                                <div class="col ms-2">
                                                                                    <div>
                                                                                        <span id="activeDropDownItem2">Gesamter
                                                                                            Zeitraum</span>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-auto my-auto mx-2 me-1">
                                                                        ...
                                                                        <div class="statsSelectStyleDropdown" id="dropdownSelectId2"
                                                                            style="display: none;">
                                                                            <div class="py-2">
                                                                                <div class="row g-0" onclick="makeSelectActive2(this,1)">
                                                                                    <div class="col-auto my-auto ps-3">
                                                                                        <div>
                                                                                            <svg width="19" height="19"
                                                                                                viewBox="0 0 19 19" fill="none"
                                                                            ...
                                                                            <div class="py-2">
                                                                                <div class="row g-0" onclick="makeSelectActive2(this,7)">
                                                                                    <div class="col-auto my-auto ps-3">
                                                                                        <div>
                                                                                            <svg class="" width="19"
                                                                                                height="19" viewBox="0 0 19 19"
                                                                            ...
                                                                            <div class="py-2">
                                                                                <div class="row g-0" onclick="makeSelectActive2(this,30)">
                                                                                    <div class="col-auto my-auto ps-3">
                                                                                        <div>
                                                                                            <svg width="19" height="19"
                                                                                                viewBox="0 0 19 19" fill="none"
                                                                            ...
                                                                            <div class="py-2">
                                                                                <div class="row g-0" onclick="makeSelectActive2(this,120)">
                                                                                    <div class="col-auto my-auto ps-3">
                                                                                        <div>
                                                                                            <svg width="19" height="19"
                                                                                                viewBox="0 0 19 19" fill="none"
                                                                            ...
                                                                            <div class="py-2">
                                                                                <div class="row g-0" onclick="makeSelectActive2(this,365)">
                                                                                    <div class="col-auto my-auto ps-3">
                                                                                        <div>
                                                                                            <svg width="19" height="19"
                                                                                                viewBox="0 0 19 19" fill="none"
                                                                            ...
                                                                            <div class="py-2">
                                                                                <div class="row g-0" onclick="makeSelectActive2(this,0)">
                                                                                    <div class="col-auto my-auto ps-3">
                                                                                        <div>
                                                                                            <svg class="activeSvg2" width="19"
                                                                                                height="19" viewBox="0 0 19 19"
                                                                                                fill="none"
                                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                                                <circle cx="9.5" cy="9.5"
                                                                            ...
                                                                            <div class="py-2" style="border-top: 1px solid #E8E8E8;">
                                                                                <div class="row g-0" onclick="statusvomvertragCostum2()"
                                                                                    style="cursor: pointer">
                                                                                    <div class="col-auto my-auto ps-3">
                                                                                        <div>
                                                                                            <svg width="18" height="12"
                                                                            ...
                                                                            <div id="statusvomvertragCostum2" style="display: none">
                                                                                <div class="py-2">
                                                                                    <div class="row g-0">
                                                                                        <div class="col my-auto ps-2 pe-2">
                                                                                            <div>
                                                                                ...
                                                                                <div class="pb-2 pt-2">
                                                                                    <div class="row g-0">
                                                                                        <div class="col my-auto ps-2 pe-2">
                                                                                            <div>
                                                                                                <input onclick="makeSelectActive2(this,100)"
                                                                                                    class="col-12 py-1" type="button"
                                                                                                    value="Suche"
                                                                                                    style="background-color:#2F60DC; color:#fff;border:#2F60DC; border-radius:8px;font-weight:700">
                                                                                            </div>
                ...
                <div class="col-12 col-lg-12 col-xl-12 col-xxl-3 mb-5">
                    <div class="greyBgStats p-3 p-sm-4 h-100">
                        <div>
                            <div style="position: relative;">
                                <div class="col my-auto">
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="statsTitleSpanAdmin">Beraters</span>
                                        </div>
                                        <div class="col">
                                            <div class="row g-0">
                                                <div class="col">
                                                ...
                                                <div class="col-auto my-auto">
                                                    ...
                                                    <div class="statsSelectStyleDropdown"
                                                        ...
                                                        <div class="py-2">
                                                            <div class="row g-0"
                                                                onclick="topBeraters(this,0)">
                                                                <div
                                                                    class="col-auto my-auto ps-3">
                                                                    <div>
                                                                        <svg class="activeSvg10"
                                                                            width="19"
                                                                            height="19"
                                                                            viewBox="0 0 19 19"
                                                                            fill="none"
                                    ...
                                    <div>
                                        <div class="row g-0">
                                            <div class="col-12 py-1" id="berateratbreeee">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-12 col-xl-12 col-xxl-8 mb-5">
                <div class="greyBgStats p-3 p-sm-4">
                    <div>
                        <div style="position: relative;">
                            <div class="col my-auto">
                                <div>
                                    <span class="statsTitleSpanAdmin">Sales Overview</span>
                                </div>
                                <div>
                                    <div class="row g-0">
                                        <div class="col-12" style="position: relative;">
                ...
                <div class="greyBgStats p-3 p-sm-4 h-100 ">
                    <div>
                        <div style="position: relative;">
                            <div class="col my-auto">
                                <div>
                                    <span class="statsTitleSpanAdmin">Temine Map</span>
                                </div>
                                <div>
                                    <div class="row g-0">
    ...
    <script>
        ...
        function beraterCostum() {
            $('#beraterCostum').slideToggle()
            $("#topBeraters").html("Individueller Zeitraum")
        }
        function opentopBeraters() {
            var x = document.getElementById("topBeratersId");
        ...
        function topBeraters(x,number){
            dateFrom = document.getElementById('beratersFrom').value
            dateTo = document.getElementById('beratersTo').value
            axios.get('topBeraters?number=' + number + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo).then(response => {
                
                document.getElementById('berateratbreeee').innerHTML = '';
                for(let i = 0; i < response.data.length;i++){
                    console.log(response.data[i]['profile'])
                    document.getElementById('berateratbreeee').innerHTML +=
                    '<div class="adminHrGreyBg my-4 py-0 px-3" >'+
                        '<div class="row py-1" >'+
                            '<div class="col-auto my-auto">'+
                            ...
                            '</div>'+
                            '<div class="col my-auto">'+
                                '<span class="fs-6" style="font-weight: 600;">'+response.data[i]['name']+'</span>'+
                                '<span class="fs-6" style="font-weight: 500;"> ('+response.data[i]['value']+'Kunden)</span>'+                                                
                            '</div>'+   
                        '</div>'+ 
                    '</div>';     
            ...
            var svg = $(x).find("svg");
            var activeSvg = document.querySelector(".activeSvg10");
            $(activeSvg).removeClass("activeSvg10");
            $(svg).addClass("activeSvg10");
            $("#topBeraters").html(y)
            $("#topBeratersId").hide()
        ...
        $(document).ready(function(){
            ...
            var infoWindow = new google.maps.InfoWindow(),
                ...
                google.maps.event.addListener(marker, 'click', (function(marker, i) {
                    return function() {
                        infoWindow.setContent('{{$app->address}}');
...
<script>
    ...
    function statusvomvertragCostum2() {
        $('#statusvomvertragCostum2').slideToggle()
        $("#activeDropDownItem2").html("Individueller Zeitraum")
    }
