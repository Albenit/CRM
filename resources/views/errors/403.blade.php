...
<div id="container">
    ...
    <div class="toph"><h1>ERROR </h1></div>
    <h3 style="color: rgb(83, 133, 145)">{{strtoupper("Benutzer hat nicht die richtigen Rollen")}}</h3>
    <h3 style="color: rgb(83, 133, 145)"><a style="text-decoration: none; color: rgb(83, 133, 145)" href="{{URL::previous()}}">KLICKEN SIE, UM ZURUCKGEHEN</a></h3>
