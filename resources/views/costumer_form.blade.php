                ...
                <form action="{{route('save_costumer_form',$costumerId)}}" method="POST">
                                ...
                                <div class="row g-0">
                                    <div class="col my-auto">
                                        <div class="row g-0">
                                            ...
                                            <div class="col col-lg-4 col-xl-4 my-auto">
                                                <div class="flaedkad me-0 me-lg-2" >
                                                    
                                                    <div>
                                                        <span class="fs-5 ms-0 ms-md-2 ms-lg-3">Berater </span>
                                                    </div>
                                                    <div class="adminName w-100 ms-2" id="back">
                                                        <div class="adminmaindivv">
                                                            <div class="ps-2 pe-4 py-1" id="admin_name">
                                                                <span> 
                                                                    {{ucfirst($costumer->lead->admin->name)}}
                                                                </span>
                                                            </div>
                                                            <div class="w-100 okoafldsq" id="new_adminName" style="display: none">
                                                                    @csrf
                                                                    ...
                                                                    <div id="butonat" class="ms-1" style="display: none" onclick="hideButtons()">
                                    ...
                                    <div class="col-12 col-lg-2 my-auto pt-2 pt-lg-0">
                                        <button type="button" class="butoniAnpassung py-0 py-md-1 w-100" style="font-weight: 600;"  onclick="window.location.href='{{route('leadfamilyperson',[Crypt::encrypt($costumer->id * 1244),'admin_id' => \Illuminate\Support\Facades\Crypt::encrypt($costumer->lead->assign_to_id * 1244),'pend_id' => \App\Models\Pendency::where('family_id',$costumer->id)->latest()->first()->id,'vorsorge' => true])}}'">
                                            Anpassung
                                        </button>
                                    </div>
                                </div>
                    ...
                    <script>
                        ...
                        function hideButtons(){
                                ...
                                document.getElementById('back').style.backgroundColor = '#fff'         
                            }
                    </script>
                             ...
                             <div class="p-4">
                                <div class="pb-5">
                                    <div class="row gx-0 gx-md-3 gy-3 mt-3">
                                        @if (keineStatus($grundversicherungP,$zusatzversicherungP,$hausratP,$autoversicherungPPFirst,$vorsorgeP,$retchsschutzP))
                                        <div class="text-center fs-6 fw-400 d-flex h-100 justify-content-center align-items-center py-4" style="color: #9F9F9F">
                                            <div class="py-4">
                                                Kein Status für dies Kunden
                                            </div>
                                        </div>
                                        @else
                                        @if($grundversicherungP->society_PG != null || $grundversicherungP->graduation_date_PG != null || $grundversicherungP->product_PG != null  || ( $grundversicherungP->status_PG != 'Offen (Berater)' && $grundversicherungP->status_PG != 'Offen (Innendienst)'))
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$grundversicherungP->society_PG}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                        <div class="row g-0 justify-content-between">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                @if($grundversicherungP->status_PG== 'Offen (Berater)')
                                                                        <span class="documentFormRightSpan" style="color: #dada58">{{$grundversicherungP->status_PG}}</span>
                                                                    @elseif($grundversicherungP->status_PG == 'Offen (Innendienst)')
                                                                        <span class="documentFormRightSpan"  style="color: #dada58">{{$grundversicherungP->status_PG}}</span>
                                                                    @elseif($grundversicherungP->status_PG == 'Eingereicht')
                                                                        <span class="documentFormRightSpan" style="color: #9F9F9F">{{$grundversicherungP->status_PG}}</span>
                                                                    @elseif($grundversicherungP->status_PG == 'Aufgenommen')
                                                                        <span class="documentFormRightSpan greencol">{{$grundversicherungP->status_PG}}</span>
                                                                    @elseif($grundversicherungP->status_PG == 'Abgelehnt')
                                                                        <span class="documentFormRightSpan" style="color: red">{{$grundversicherungP->status_PG}}</span>
                                                                    @elseif($grundversicherungP->status_PG == 'Provisionert'  && $grundversicherungP->stoiner_PG == null)
                                                                        <span class="documentFormRightSpan" style="color: green !important;">{{$grundversicherungP->status_PG}}</span>
                                                                    @endif
                                                                    @if($grundversicherungP->stoiner_PG == 'Storniert')
                                                                        <span class="documentFormRightSpan" style="color: green !important;">{{$grundversicherungP->stoiner_PG}}</span>
                                                                    @endif
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{Carbon\Carbon::parse($grundversicherungP->last_adjustment_PG)->format('d.m.Y')}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @if($grundversicherungP->status_PG == 'Provisionert' || $grundversicherungP->status_PG == 'Storniert')
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan colori-green">{{$grundversicherungP->total_commisions_PG}}CHF</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endif
                                        ...
                                        @endif
                                        @if($zusatzversicherungP->society_PZ != null || $zusatzversicherungP->product_PZ != null || $zusatzversicherungP->graduation_date_PZ != null || ( $zusatzversicherungP->status_PZ != 'Offen (Berater)' && $zusatzversicherungP->status_PZ != 'Offen (Innendienst)'))
                                        <div class="col-12 col-md-6 col-xl-4">
                                            <div class="documentFormGreyBGDiv h-100">
                                                <div class="p-4">
                                                    <div class="pb-3">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$zusatzversicherungP->society_PZ}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                @if($zusatzversicherungP->status_PZ== 'Offen (Berater)')
                                                                        <span class="documentFormRightSpan" style="color: #dada58">{{$zusatzversicherungP->status_PZ}}</span>
                                                                    @elseif($zusatzversicherungP->status_PZ == 'Offen (Innendienst)')
                                                                        <span class="documentFormRightSpan"  style="color: #dada58">{{$zusatzversicherungP->status_PZ}}</span>
                                                                    @elseif($zusatzversicherungP->status_PZ == 'Eingereicht')
                                                                        <span class="documentFormRightSpan" style="color: #9F9F9F">{{$zusatzversicherungP->status_PZ}}</span>
                                                                    @elseif($zusatzversicherungP->status_PZ == 'Aufgenommen')
                                                                        <span class="documentFormRightSpan greencol">{{$zusatzversicherungP->status_PZ}}</span>
                                                                    @elseif($zusatzversicherungP->status_PZ == 'Abgelehnt')
                                                                        <span class="documentFormRightSpan" style="color: red">{{$zusatzversicherungP->status_PZ}}</span>
                                                                    @elseif($zusatzversicherungP->status_PZ == 'Provisionert'  && $zusatzversicherungP->stoiner_PZ == null)
                                                                        <span class="documentFormRightSpan" style="color: green !important;">{{$zusatzversicherungP->status_PZ}}</span>
                                                                    @endif
                                                                    @if($zusatzversicherungP->stoiner_PZ == 'Storniert')
                                                                        <span class="documentFormRightSpan" style="color: green !important;">{{$zusatzversicherungP->stoiner_PZ}}</span>
                                                                    @endif
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan ">{{Carbon\Carbon::parse($zusatzversicherungP->last_adjustment_PZ)->format('d.m.Y')}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @if($zusatzversicherungP->status_PZ == 'Provisionert' || $zusatzversicherungP->status_PZ == 'Storniert')
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            <div class="col-7">
                                                                <span class="documentFormLeftSpan">Gesamtprovision</span>
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan colori-green">{{$zusatzversicherungP->total_commisions_PZ}}CHF</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endif
                                    ...
                                    <div class="col g-0 text-center">
                                        <div class="">
                                            <button type="button" class="px-5 py-1"
                                                    style="border: none; border-radius: 7px; background-color:#2F60DC;color: #fff;font-weight: 600"
                                                    onclick="nextonee()">
                                                    Uberspringen
                                            </button>
                                        </div>
                                ...
                                <div class="pb-5">
                                    ...
                                    <div class="row g-0 mt-3">
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4 pe-0 pe-md-0 pe-xl-4 ps-0 ps-md-0 ps-xl-0">
                                            <div class="documentFormGreyBGDiv p-4 ">
                                                <div class="my-1">
                            ...
                            <div class="row mx-2 mx-sm-4">
                                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 my-0 my-sm-3">
                                    ...
                                    <div class="pt-3 pb-1 py-sm-3">
                                        <div class="accordion accordion-flush" id="accordionFlushExample000666">
                                            <div class="accordion-item"
                                                 style="background-color: #f7f9fd !important;border-radius: 15px;">
                                                <h2 class="accordion-header" id="flush-heading000666">
                                                    <button class="accordion-button collapsed" type="button"
                                                            data-bs-toggle="collapse"
                                                            data-bs-target="#flush-collapse000666"
                                                            aria-expanded="false" aria-controls="flush-heading000666"
                                                ...
                                                <div id="flush-collapse000666" class="accordion-collapse collapse"
                                                     aria-labelledby="flush-heading000666"
                                                     data-bs-parent="#accordionFlushExample000666">
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="date"
                                                                       name="graduation_date_PG" id="" min="1900-01-01"
                                                                       max="9999-12-31" value="{{$grundversicherungP->graduation_date_PG}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <select class="form-select"
                                                                    ...
                                                                    @if($grundversicherungP->society_PG != null && $grundversicherungP->society_PG != '')
                                                                        <option selected value="{{$grundversicherungP->society_PG}}">{{$grundversicherungP->society_PG}}</option>
                                                                    @else
                                                                        <option value=""></option>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="text"
                                                                       name="product_PG" id="" value="{{$grundversicherungP->product_PG}}">
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <select class="form-select"
                                                                    ...
                                                                    @elseif($grundversicherungP->status_PG == 'Provisionert')
                                                                        <option selected value="Provisionert">Provisionert</option>
                                                                    @endif
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <div class="GrundversicherungInput form-control" style="background-color: #f3f1f1"> 
                                                                    <span>{{Carbon\Carbon::parse($grundversicherungP->last_adjustment_PG)->format('d.m.Y')}}</span>
                                                                </div>
                                                                
                                                            </div>

                                                        </div>
                                                        @if($grundversicherungP->status_PG == 'Provisionert')
                                                        <div class="mb-3">
                                                            <div
                                                                class="input-div1 input-groupp justify-content-between">
                                                                <div class="pe-3">
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="number"
                                                                       name="total_commisions_PG" id="" value="{{$grundversicherungP->total_commisions_PG}}">
                                                            </div>
                                                        </div>
                                                            @endif
                                                    </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <select class="form-select"
                                                                    ...
                                                                    <option selected value="{{$autoversicherungP->society_PA}}">{{$autoversicherungP->society_PA}}</option>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="date"
                                                                       ...
                                                                       min="1900-01-01" max="9999-12-31" value="{{$autoversicherungP->beginning_insurance_PA}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="text"
                                                                       name="insurance_PA" id="" value="{{$autoversicherungP->insurance_PA}}">
                                                            </div>
                                                        ...
                                                        @if($autoversicherungP->status_PA == 'Provisionert')
                                                        <div class="mb-3">
                                                            <div
                                                                class="input-div1 input-groupp justify-content-between">
                                                                <div class="pe-3">
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="number"
                                                                       name="total_commisions_PA" id="" value="{{$autoversicherungP->total_commisions_PA}}">
                                                            </div>
                                                        </div>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="date"
                                                                       name="graduation_date_PZ" id="" min="1900-01-01"
                                                                       max="9999-12-31" value="{{$zusatzversicherungP->graduation_date_PZ}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="text"
                                                                       name="produkt_PZ" id="" value="{{$zusatzversicherungP->produkt_PZ}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="text"
                                                                       name="vvg_premium_PZ" id="" value="{{$zusatzversicherungP->vvg_premium_PZ}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="date"
                                                                       ...
                                                                       min="1900-01-01" max="9999-12-31" value="{{$zusatzversicherungP->duration_from_PZ}}">
                                                                <label for="to">Bis</label>
                                                                <input class="GrundversicherungInput form-control" type="date"
                                                                       name="duration_to_PZ" id="to" min="1900-01-01"
                                                                       max="9999-12-31" value="{{$zusatzversicherungP->duration_to_PZ}}">
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <div
                                                        ...
                                                        {{-- <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="text"
                                                                       name="provision_PZ" id="" value="{{$zusatzversicherungP->provision_PZ}}">
                                                            </div>
                                                        </div> --}}
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="number"
                                                                       name="total_commisions_PZ" id="" value="{{$zusatzversicherungP->total_commisions_PZ}}">
                                                            </div>
                                                        </div>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="date"
                                                                       ...
                                                                       min="1900-01-01" max="9999-12-31" value="{{$hausratP->beginning_insurance_PH}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="text"
                                                                       name="insurance_PH" id="" value="{{$hausratP->insurance_PH}}">
                                                            </div>
                                                        ...
                                                        @if($hausratP->status_PH == 'Provisionert')
                                                        <div class="mb-3">
                                                            <div
                                                                class="input-div1 input-groupp justify-content-between">
                                                                <div class="pe-3">
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="number"
                                                                       name="total_commisions_PH" id="" value="{{$hausratP->total_commisions_PH}}">
                                                            </div>
                                                        </div>
                                                            @endif
                                                    </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="date"
                                                                       ...
                                                                       max="9999-12-31" value="{{$vorsorgeP->graduation_date_PV}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="date"
                                                                       ...
                                                                       max="9999-12-31" value="{{$vorsorgeP->begin_PV}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="text"
                                                                       name="pramie_PV" id="" value="{{$vorsorgeP->pramie_PV}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="text"
                                                                       name="payment_rythm_PV" id="" value="{{$vorsorgeP->payment_rythm_PV}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="date"
                                                                       ...
                                                                       min="1900-01-01" max="9999-12-31" value="{{$vorsorgeP->duration_from_PV}}">
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="text"
                                                                       name="production_PV" id="" value="{{$vorsorgeP->production_PV}}">
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <div
                                                        ...
                                                        <div class="mb-3">
                                                            <div
                                                                ...
                                                                <input class="GrundversicherungInput form-control" type="number"
                                                                       name="total_commisions_PV" id="" value="{{$vorsorgeP->total_commisions_PV}}">
                                                            </div>
                                                        </div>
                                                        @endif
                                                    </div>
...
{{--            '<div class="accordion-body" style="background-color: #f7f9fd !important; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
{{--            '<div class="pe-3">' +--}}
{{--            '<span class="GrundversicherungSpans">Abschlussdatum: </span>' +--}}
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="date" name="graduation_date_PG' + i + '"' + ' id="" min="1900-01-01" max="9999-12-31">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '</div>'+--}}
{{--            '<input class="GrundversicherungInput form-control" type="text" name="society_PG' + i + '"' + ' id="">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="text" name="product_PG' + i + '"' + ' id="">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="date" name="last_adjustment_PG' + i + '"' + ' id="" min="1900-01-01" max="9999-12-31">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="number" name="total_commisions_PG' + i + '"' + ' id="">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '</div>'+--}}
{{--            '</div>');--}}
...
{{--            '<span class="GrundversicherungSpans">Abschlussdatum: </span>' +--}}
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="date" name="graduation_date_PG' + i + '"' + ' readonly id="" min="1900-01-01" max="9999-12-31">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '<span class="GrundversicherungSpans">Gesellschaft: </span>' +--}}
{{--            '</div>'+--}}
{{--            '<input class="GrundversicherungInput form-control" type="text" name="society_PG' + i + '"' + ' id="" readonly>' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '<span class="GrundversicherungSpans">Produkt </span>' +--}}
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="text" name="product_PG' + i + '"' + ' id="" readonly>' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '<span class="GrundversicherungSpans">Letze Anpassung </span>' +--}}
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="date" name="last_adjustment_PG' + i + '"' + ' id="" readonly min="1900-01-01" max="9999-12-31">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '<span class="GrundversicherungSpans">Gesamtprovision: </span>' +--}}
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="number" name="total_commisions_PG' + i + '"' + ' id="" readonly>' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '</div>'+--}}
{{--            '</div>');--}}
...
<script>
    ...
    for (i = 2; i <= count; i++) {
                $("#accordionFlushExample0044").append(
                    '<div id="flush-collapse0044" class="accordion-collapse collapse" aria-labelledby="flush-heading0044" data-bs-parent="#accordionFlushExample0044">' +
                    '<div class="accordion-body" style="background-color: #f7f9fd !important; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">'+
                    '<div class="mb-3">'+
                    '<div class="input-div1 input-groupp justify-content-between">'+
                    '<div class="pe-3">'+
                    '<span class="GrundversicherungSpans">Gesellschaft: </span>'+
                    '</div>'+
                    '<select class="form-select"aria-label="Default select example" name="society_PA' + i + '"><option selected></option> <option value="Helvetia">Helvetia</option> <option value="Zurich">Zurich</option> <option value="Axa">Axa</option> </select>'+
                    '</div>'+
                    '</div>'+
                    '<div class="mb-3">'+
                    '<div class="input-div1 input-groupp justify-content-between">'+
                    '<div class="pe-3">'+
                    '<span class="GrundversicherungSpans">Beginn Versicherung: </span>'+
                    '</div>'+
                    '<input class="GrundversicherungInput form-control" type="date" name="beginning_insurance_PA' + i + '" id="" min="1900-01-01" max="9999-12-31" >'+
                    '</div>'+
                    '</div>'+
                    '<div class="mb-3">'+
                    '<div class="input-div1 input-groupp justify-content-between">'+
                    '<div class="pe-3">'+
                    '<span class="GrundversicherungSpans">Versicherung: </span>'+
                    '</div>'+
                    '<input class="GrundversicherungInput form-control" type="text" name="insurance_PA' + i + '" id="" >'+
                    '</div>'+
                    '</div>'+
                    '<div class="mb-3">'+
                    '<div class="input-div1 input-groupp justify-content-between">'+
                    ...
                    '<span class="GrundversicherungSpans">Status: </span>'+
                    '</div>'+
                    '<select class="form-select"aria-label="Default select example" name="status_PA' + i + '"> <option selected ></option> <option value="Aufgenomen">Aufgenomen </option> <option value="Offen">Offen</option> <option value="Abgelehnt">Abgelehnt </option> <option value="Zuruckgezogen">Zuruckgezogen</option> <option value="Provisionert">Provisionert </option> <option value="Nicht Ausgewählt">Nicht Ausgewählt</option> </select>'+
                    '</div>'+
                    '</div>'+
                    '<div class="mb-3">'+
                    '<div class="input-div1 input-groupp justify-content-between">'+
                    ...
                    '<span class="GrundversicherungSpans">Letze Anpassung: </span>'+
                    '</div>'+
                    '<input class="GrundversicherungInput form-control" type="date" id=""min="1900-01-01" max="9999-12-31"  readonly>'+
                    '</div>'+
                    '</div>'+
                    '<div class="mb-3">'+
                    '<div class="input-div1 input-groupp justify-content-between">'+
                    ...
                    '<span class="GrundversicherungSpans">Gesamtprovision: </span>'+
                    '</div>'+
                    '<input class="GrundversicherungInput form-control" type="number" name="total_commisions_PA' + i + '" id="" >'+
                    '</div>'+
                    '</div>'+
                    '</div>'
                );
...
{{--            '<span class="GrundversicherungSpans">Abschlussdatum: </span>' +--}}
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" readonly type="date" name="graduation_date_PZ' + i + '"' + ' id="" min="1900-01-01" max="9999-12-31">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
{{--            '<div class="pe-3">' +--}}
{{--            '<span class="GrundversicherungSpans">Gesellschaft: </span> </div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" readonly type="text" name="society_PZ' + i + '"' + ' id="">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '<span class="GrundversicherungSpans">Produkt </span>' +--}}
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="text" name="produkt_PZ' + i + '"' + ' id="" readonly>' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="text" name="vvg_premium_PZ' + i + '"' + ' id="" readonly>' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
{{--            '<div class="pe-3">' +--}}
{{--            '<span class="GrundversicherungSpans">Laufzeit: </span>' +--}}
{{--            '</div>' +--}}
{{--            '<label for="from">Von</label>' +--}}
{{--            '<input class="GrundversicherungInput form-control" readonly type="date" name="duration_from_PZ' + i + '"' + ' id="from" min="1900-01-01" max="9999-12-31">' +--}}
{{--            '<label for="to">Bis</label>' +--}}
{{--            '<input class="GrundversicherungInput form-control" readonly type="date" name="duration_to_PZ' + i + '"' + ' id="to" min="1900-01-01" max="9999-12-31">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '<span class="GrundversicherungSpans">Letze Anpassung: </span>' +--}}
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" readonly type="date" name="last_adjustment_PZ' + i + '"' + ' id="" min="1900-01-01" max="9999-12-31">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" readonly type="text" name="provision_PZ' + i + '"' + ' id="">' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '<div class="mb-3">' +--}}
{{--            '<div class="input-div1 input-groupp justify-content-between">' +--}}
...
{{--            '<span class="GrundversicherungSpans">Gesamtprovision: </span>' +--}}
{{--            '</div>' +--}}
{{--            '<input class="GrundversicherungInput form-control" type="number" name="total_commisions_PZ' + i + '"' + ' id="" readonly>' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '</div>' +--}}
{{--            '</div>');--}}
