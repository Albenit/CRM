            ...
            <div class="" style="background-color: #EFEFEF;border-radius: 22px;">
                ...
                <form action="{{route('save_costumer_form',$costumerId)}}" method="POST">
                    ...
                    <span class="fs-4">
                            ...
                            <div class="col">
                                <div class="row g-0">
                                    <div class="col-auto my-auto pe-2">
                                        ...
                                        <svg width="17" height="17" viewBox="0 0 14 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path d="M12 2L2 12L12 22" stroke="#434343" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                                                            </svg>
                                        </a>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="fs-6 text-muted justify-content-end d-flex">
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan">{{$grundversicherungP->last_adjustment_PG}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <div class="pb-4">
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col">
                                                                <span class="documentFormRightSpan ">{{$zusatzversicherungP->last_adjustment_PZ}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
...
{{--                                                                       name="last_adjustment_PG" --}}
                                                                       id="" min="1900-01-01"
                                                                       max="9999-12-31" value="{{$grundversicherungP->last_adjustment_PG}}" readonly>
                                                            </div>
...
{{--                                                                       name="last_adjustment_PA" id=""--}}
                                                                       min="1900-01-01" max="9999-12-31" value="{{$autoversicherungP->last_adjustment_PA}}" readonly>
                                                            </div>
                                                        </div>
...
{{--                                                                       name="last_adjustment_PZ" id=""--}}
                                                                       min="1900-01-01"
                                                                       max="9999-12-31" value="{{$zusatzversicherungP->last_adjustment_PZ}}" readonly>
                                                            </div>
